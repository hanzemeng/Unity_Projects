                        ...
                        !EmeraldComponent.IsGettingHit && EmeraldComponent.CurrentBlockingState == EmeraldAISystem.BlockingState.NotBlocking)
                    {
                            ...
                            EmeraldComponent.DestinationAdjustedAngle <= EmeraldComponent.MaxDamageAngle && m_TargetHeight <= EmeraldComponent.AttackHeight && !EmeraldComponent.TargetObstructed)
                        {
                                ...
                                EmeraldComponent.EnableBothWeaponTypes == EmeraldAISystem.YesOrNo.Yes && EmeraldComponent.WeaponTypeRef == EmeraldAISystem.WeaponType.Ranged)
                            {
                                ...
                                if (EmeraldComponent.isSupportAbility || (!EmeraldComponent.m_AbilityPicked && EmeraldComponent.SupportAbilities.Count > 0 && !EmeraldComponent.HealingCooldownActive && 
                                ...
                                else if (EmeraldComponent.isSummoningAbility || (!EmeraldComponent.m_AbilityPicked && EmeraldComponent.TotalSummonedAI < EmeraldComponent.MaxAllowedSummonedAI && EmeraldComponent.SummoningAbilities.Count > 0))
                                {
                                ...
                                else if (EmeraldComponent.isOffensiveAbility || (!EmeraldComponent.m_AbilityPicked && EmeraldComponent.OffensiveAbilities.Count > 0))                             
                                {
